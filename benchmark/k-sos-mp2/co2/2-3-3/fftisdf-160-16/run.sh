...
#SBATCH --job-name=co2-fftisdf-160-16-kmesh-2-3-3
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/co2/2-3-3/fftisdf-160-16/scf.chk scf.chk
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/co2/2-3-3/fftisdf-160-16/tmp/df.h5 tmp/df.h5

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=fftisdf-160-16 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
