...
#SBATCH --job-name=co2-fftisdf-180-16-kmesh-3-3-4
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/co2/3-3-4/fftisdf-180-16/scf.chk scf.chk
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/co2/3-3-4/fftisdf-180-16/tmp/df.h5 tmp/df.h5

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-4 --density-fitting-method=fftisdf-180-16 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
