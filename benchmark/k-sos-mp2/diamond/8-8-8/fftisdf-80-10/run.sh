...
#SBATCH --job-name=diamond-fftisdf-80-10-kmesh-8-8-8
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=8-8-8 --density-fitting-method=fftisdf-80-10 --name=diamond --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
