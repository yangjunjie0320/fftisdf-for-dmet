...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=fftisdf-60-16 --name=diamond --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
