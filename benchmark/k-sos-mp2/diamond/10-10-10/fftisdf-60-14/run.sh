...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=10-10-10 --density-fitting-method=fftisdf-60-14 --name=diamond --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
