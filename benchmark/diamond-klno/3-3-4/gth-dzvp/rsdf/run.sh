...
python main.py --kmesh=3-3-4 --basis=gth-dzvp --density-fitting-method=rsdf --ke-cutoff=0.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
