...
python main.py --kmesh=4-4-4 --basis=gth-dzvp --density-fitting-method=fftisdf-20 --ke-cutoff=100 --name=diamond --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
