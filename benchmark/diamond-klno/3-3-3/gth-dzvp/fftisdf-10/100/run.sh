...
python main.py --kmesh=3-3-3 --basis=gth-dzvp --density-fitting-method=fftisdf-10 --ke-cutoff=100 --name=diamond --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
