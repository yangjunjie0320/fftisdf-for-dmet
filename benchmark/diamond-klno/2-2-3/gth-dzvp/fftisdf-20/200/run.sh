...
python main.py --kmesh=2-2-3 --basis=gth-dzvp --density-fitting-method=fftisdf-20 --ke-cutoff=200 --name=diamond --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
