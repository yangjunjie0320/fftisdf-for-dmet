...
#SBATCH --job-name=cco-afm-gdf-1.2-kmesh-4-4-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-3 --density-fitting-method=gdf-1.2 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
