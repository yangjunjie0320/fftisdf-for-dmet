...
#SBATCH --job-name=cco-afm-fftdf-140-kmesh-1-1-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-2 --density-fitting-method=fftdf-140 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
