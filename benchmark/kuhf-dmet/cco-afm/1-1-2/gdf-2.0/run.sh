...
#SBATCH --job-name=cco-afm-gdf-2.0-kmesh-1-1-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-2 --density-fitting-method=gdf-2.0 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
