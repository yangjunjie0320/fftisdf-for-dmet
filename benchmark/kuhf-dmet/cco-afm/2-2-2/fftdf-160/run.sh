...
#SBATCH --job-name=cco-afm-fftdf-160-kmesh-2-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftdf-160 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
