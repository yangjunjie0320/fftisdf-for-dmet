...
#SBATCH --job-name=nio-afm-fftisdf-180-25-kmesh-4-4-4
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm-beta-1000/4-4-4/fftisdf-180-25/scf.chk scf.chk
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm-beta-1000/4-4-4/fftisdf-180-25/tmp/df.h5 tmp/df.h5

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftisdf-180-25 --name=nio-afm --init-guess-method=minao --dmet-beta=100.0 --is-unrestricted
echo "End time = $(date)"
