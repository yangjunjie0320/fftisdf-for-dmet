...
#SBATCH --job-name=nio-afm-gdf-2.0-kmesh-4-4-4
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm-beta-1000/4-4-4/gdf-2.0/scf.chk scf.chk
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm-beta-1000/4-4-4/gdf-2.0/tmp/df.h5 tmp/df.h5

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=gdf-2.0 --name=nio-afm --init-guess-method=minao --dmet-beta=100.0 --is-unrestricted
echo "End time = $(date)"
