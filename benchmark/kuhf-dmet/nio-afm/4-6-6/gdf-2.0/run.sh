...
#SBATCH --job-name=nio-afm-gdf-2.0-kmesh-4-6-6
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-6-6 --density-fitting-method=gdf-2.0 --name=nio-afm --init-guess-method=minao --is-unrestricted
echo "End time = $(date)"
