...
#SBATCH --job-name=nio-afm-fftisdf-180-25-kmesh-3-4-4
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm/3-4-4/fftisdf-180-24/scf.chk scf.chk
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=fftisdf-180-25 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
