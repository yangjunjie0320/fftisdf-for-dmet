...
#SBATCH --job-name=nio-afm-gdf-1.4-kmesh-1-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-2-2 --density-fitting-method=gdf-1.4 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
