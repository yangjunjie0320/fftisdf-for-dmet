...
#SBATCH --job-name=nio-afm-fftisdf-200-32-kmesh-1-1-2
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm/1-1-2/fftisdf-200-20/scf.chk scf.chk
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-2 --density-fitting-method=fftisdf-200-32 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
