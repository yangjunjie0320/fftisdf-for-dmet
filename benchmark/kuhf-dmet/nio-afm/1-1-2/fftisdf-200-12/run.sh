...
#SBATCH --job-name=nio-afm-fftisdf-200-12-kmesh-1-1-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-2 --density-fitting-method=fftisdf-200-12 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
