...
#SBATCH --job-name=nio-afm-fftisdf-180-40-kmesh-1-1-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-2 --density-fitting-method=fftisdf-180-40 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
