...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-4 --density-fitting-method=fftisdf-180-25 --name=nio-afm --init-guess-method=chk --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-25-kmesh-3-3-4/53668762/df.h5 --is-unrestricted
echo "End time = $(date)"
