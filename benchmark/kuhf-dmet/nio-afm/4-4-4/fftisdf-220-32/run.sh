...
#SBATCH --job-name=nio-afm-fftisdf-220-32-kmesh-4-4-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftisdf-220-32 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
