...
#SBATCH --job-name=nio-afm-gdf-1.8-kmesh-4-4-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=gdf-1.8 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
