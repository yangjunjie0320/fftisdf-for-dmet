...
#SBATCH --job-name=nio-afm-fftisdf-180-32-kmesh-2-3-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=fftisdf-180-32 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
