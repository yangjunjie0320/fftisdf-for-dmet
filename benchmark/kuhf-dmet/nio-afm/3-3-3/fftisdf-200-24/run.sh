...
#SBATCH --job-name=nio-afm-fftisdf-200-24-kmesh-3-3-3
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm/3-3-3/fftisdf-200-20/scf.chk scf.chk
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-3 --density-fitting-method=fftisdf-200-24 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
