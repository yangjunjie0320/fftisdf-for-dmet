...
#SBATCH --job-name=nio-afm-fftisdf-180-25-kmesh-2-3-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=fftisdf-180-25 --name=nio-afm --init-guess-method=chk --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-25-kmesh-2-3-3/53668758/df.h5 --is-unrestricted
echo "End time = $(date)"
