...
#SBATCH --job-name=nio-afm-fftisdf-220-16-kmesh-2-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftisdf-220-16 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
