...
#SBATCH --job-name=nio-afm-gdf-2.2-kmesh-3-3-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-3 --density-fitting-method=gdf-2.2 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
