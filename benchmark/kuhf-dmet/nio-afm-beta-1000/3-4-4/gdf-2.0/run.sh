...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=gdf-2.0 --name=nio-afm --init-guess-method=chk --df-to-read=/resnick/scratch/yangjunjie/nio-afm-gdf-2.0-kmesh-3-4-4/53668763/df.h5 --is-unrestricted
echo "End time = $(date)"
