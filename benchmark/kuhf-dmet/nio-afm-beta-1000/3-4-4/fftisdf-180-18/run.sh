...
#SBATCH --job-name=nio-afm-fftisdf-180-18-kmesh-3-4-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=fftisdf-180-18 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
