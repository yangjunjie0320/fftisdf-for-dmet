...
#SBATCH --job-name=nio-afm-fftisdf-180-25-kmesh-4-4-6
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-6 --density-fitting-method=fftisdf-180-25 --name=nio-afm --init-guess-method=minao --is-unrestricted
echo "End time = $(date)"
