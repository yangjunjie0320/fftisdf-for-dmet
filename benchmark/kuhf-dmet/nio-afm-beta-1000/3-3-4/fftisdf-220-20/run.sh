...
#SBATCH --job-name=nio-afm-fftisdf-220-20-kmesh-3-3-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-4 --density-fitting-method=fftisdf-220-20 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
