...
#SBATCH --job-name=nio-afm-fftisdf-180-28-kmesh-4-4-4
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm/4-4-4/fftisdf-200-20/scf.chk scf.chk
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftisdf-180-28 --name=nio-afm --init-guess-method=chk --is-unrestricted
echo "End time = $(date)"
