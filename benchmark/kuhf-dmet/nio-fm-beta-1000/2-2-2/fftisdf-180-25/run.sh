...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftisdf-180-25 --name=nio-fm --init-guess-method=chk --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-24-kmesh-2-2-2/53639121/df.h5 --is-unrestricted
echo "End time = $(date)"
