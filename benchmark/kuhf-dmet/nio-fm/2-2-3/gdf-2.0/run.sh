...
#SBATCH --job-name=nio-fm-gdf-2.0-kmesh-2-2-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-3 --density-fitting-method=gdf-2.0 --name=nio-fm --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-24-kmesh-2-2-3/53639145/df.h5 --is-unrestricted
echo "End time = $(date)"
