...
#SBATCH --job-name=nio-fm-fftisdf-180-25-kmesh-2-2-2
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/kuhf-dmet/nio-afm/2-2-2/fftisdf-180-25/tmp/df.h5 tmp/df.h5

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftisdf-180-25 --name=nio-fm --df-to-read=./tmp/df.h5 --is-unrestricted
echo "End time = $(date)"
