...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=fftisdf-180-25 --name=nio-fm --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-24-kmesh-3-4-4/53639241/df.h5 --is-unrestricted
echo "End time = $(date)"
