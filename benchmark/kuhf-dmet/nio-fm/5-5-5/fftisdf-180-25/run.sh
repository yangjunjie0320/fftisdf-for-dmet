...
#SBATCH --job-name=nio-fm-fftisdf-180-25-kmesh-5-5-5
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=5-5-5 --density-fitting-method=fftisdf-180-25 --name=nio-fm --init-guess-method=minao --df-to-read=/resnick/scratch/yangjunjie/nio-afm-fftisdf-180-25-kmesh-5-5-5/53856944/df.h5 --is-unrestricted
echo "End time = $(date)"
