...
#SBATCH --job-name=co2-fftisdf-120-18
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-2-2 --density-fitting-method=fftisdf-120-18 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
