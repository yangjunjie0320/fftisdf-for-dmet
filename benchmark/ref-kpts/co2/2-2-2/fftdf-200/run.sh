...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftdf-200 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
