...
#SBATCH --job-name=co2-fftisdf-80-16
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-3 --density-fitting-method=fftisdf-80-16 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
