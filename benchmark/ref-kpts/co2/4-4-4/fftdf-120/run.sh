...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftdf-120 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
