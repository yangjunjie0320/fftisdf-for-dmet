...
#SBATCH --job-name=co2-fftisdf-60-20
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftisdf-60-20 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
