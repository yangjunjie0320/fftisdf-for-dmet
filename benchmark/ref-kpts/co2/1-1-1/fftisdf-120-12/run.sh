...
#SBATCH --job-name=co2-fftisdf-120-12
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=fftisdf-120-12 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
