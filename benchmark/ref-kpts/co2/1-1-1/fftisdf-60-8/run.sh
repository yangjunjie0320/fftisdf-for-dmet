...
#SBATCH --job-name=co2-fftisdf-60-8
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=fftisdf-60-8 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
