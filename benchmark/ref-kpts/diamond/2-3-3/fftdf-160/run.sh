...
#SBATCH --job-name=diamond-fftdf-160
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=fftdf-160 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
