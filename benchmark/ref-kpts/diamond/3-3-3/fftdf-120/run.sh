...
#SBATCH --job-name=diamond-fftdf-120
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-3 --density-fitting-method=fftdf-120 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
