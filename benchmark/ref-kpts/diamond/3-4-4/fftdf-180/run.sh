...
#SBATCH --job-name=diamond-fftdf-180
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-4-4 --density-fitting-method=fftdf-180 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
