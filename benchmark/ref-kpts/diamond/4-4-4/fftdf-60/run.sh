...
#SBATCH --job-name=diamond-fftdf-60
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftdf-60 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
