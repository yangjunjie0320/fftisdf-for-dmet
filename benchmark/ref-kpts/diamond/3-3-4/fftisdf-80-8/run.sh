...
#SBATCH --job-name=diamond-fftisdf-80-8
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-4 --density-fitting-method=fftisdf-80-8 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
