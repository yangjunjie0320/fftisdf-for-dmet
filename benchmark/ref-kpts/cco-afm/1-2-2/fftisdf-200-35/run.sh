...
#SBATCH --job-name=cco-afm-fftisdf-200-35-kmesh-1-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-2-2 --density-fitting-method=fftisdf-200-35 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
