...
#SBATCH --job-name=cco-afm-fftisdf-160-24-kmesh-1-1-1
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=fftisdf-160-24 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
