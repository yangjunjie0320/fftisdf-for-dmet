...
#SBATCH --job-name=cco-afm-fftisdf-160-28-kmesh-2-2-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-4 --density-fitting-method=fftisdf-160-28 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
