...
#SBATCH --job-name=cco-afm-fftisdf-200-25-kmesh-2-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftisdf-200-25 --name=cco-afm --is-unrestricted
echo "End time = $(date)"
