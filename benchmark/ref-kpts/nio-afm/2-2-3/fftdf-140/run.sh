...
#SBATCH --job-name=nio-afm-fftdf-140-kmesh-2-2-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-3 --density-fitting-method=fftdf-140 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
