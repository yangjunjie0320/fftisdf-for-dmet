...
#SBATCH --job-name=nio-afm-gdf-2.0-kmesh-2-3-3
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=gdf-2.0 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
