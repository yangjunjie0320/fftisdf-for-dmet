...
#SBATCH --job-name=nio-afm-fftdf-220-kmesh-1-1-1
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=fftdf-220 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
