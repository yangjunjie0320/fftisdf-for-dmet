...
#SBATCH --job-name=nio-afm-gdf-1.6-kmesh-1-1-1
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=gdf-1.6 --name=nio-afm --is-unrestricted
echo "End time = $(date)"
