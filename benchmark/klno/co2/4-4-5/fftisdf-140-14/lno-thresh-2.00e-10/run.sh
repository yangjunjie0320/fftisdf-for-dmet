...
#SBATCH --job-name=co2-fftisdf-140-14-kmesh-4-4-5-lno-thresh-2.00e-10
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-5 --density-fitting-method=fftisdf-140-14 --lno-thresh=2e-10 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
