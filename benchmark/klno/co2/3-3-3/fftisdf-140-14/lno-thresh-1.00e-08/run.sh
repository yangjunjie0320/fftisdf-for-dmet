...
#SBATCH --job-name=co2-fftisdf-140-14-kmesh-3-3-3-lno-thresh-1.00e-08
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=3-3-3 --density-fitting-method=fftisdf-140-14 --lno-thresh=1e-08 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
