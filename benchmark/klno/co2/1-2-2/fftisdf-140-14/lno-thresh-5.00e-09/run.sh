...
#SBATCH --job-name=co2-fftisdf-140-14-kmesh-1-2-2-lno-thresh-5.00e-09
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-2-2 --density-fitting-method=fftisdf-140-14 --lno-thresh=5e-09 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
