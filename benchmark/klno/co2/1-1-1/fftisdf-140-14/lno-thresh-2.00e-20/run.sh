...
#SBATCH --job-name=co2-fftisdf-140-14-kmesh-1-1-1-lno-thresh-2.00e-20
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=1-1-1 --density-fitting-method=fftisdf-140-14 --lno-thresh=2e-20 --name=co2 --init-guess-method=chk --df-to-read=./tmp/df.h5
echo "End time = $(date)"
