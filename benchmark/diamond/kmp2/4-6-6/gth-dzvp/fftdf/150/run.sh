...
#SBATCH --job-name=diamond-kmp2-4-6-6-gth-dzvp-fftdf-150
#SBATCH --ntasks=1
...
python main.py --kmesh=4-6-6 --basis=gth-dzvp --density-fitting-method=fftdf-150 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
