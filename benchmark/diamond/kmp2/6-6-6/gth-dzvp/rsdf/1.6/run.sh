...
#SBATCH --job-name=diamond-kmp2-6-6-6-gth-dzvp-rsdf-1.6
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-6 --basis=gth-dzvp --density-fitting-method=rsdf-1.6 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
