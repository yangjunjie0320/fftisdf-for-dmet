...
#SBATCH --job-name=diamond-kmp2-6-8-8-gth-dzvp-fftdf-100
#SBATCH --ntasks=1
...
python main.py --kmesh=6-8-8 --basis=gth-dzvp --density-fitting-method=fftdf-100 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
