...
#SBATCH --job-name=diamond-kmp2-6-8-8-gth-dzvp-rsdf-1.4
#SBATCH --ntasks=1
...
python main.py --kmesh=6-8-8 --basis=gth-dzvp --density-fitting-method=rsdf-1.4 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
