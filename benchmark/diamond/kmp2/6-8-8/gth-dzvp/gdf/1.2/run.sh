...
#SBATCH --job-name=diamond-kmp2-6-8-8-gth-dzvp-gdf-1.2
#SBATCH --ntasks=1
...
python main.py --kmesh=6-8-8 --basis=gth-dzvp --density-fitting-method=gdf-1.2 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
