...
#SBATCH --job-name=diamond-kmp2-8-8-8-gth-dzvp-rsdf-1.8
#SBATCH --ntasks=1
...
python main.py --kmesh=8-8-8 --basis=gth-dzvp --density-fitting-method=rsdf-1.8 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
