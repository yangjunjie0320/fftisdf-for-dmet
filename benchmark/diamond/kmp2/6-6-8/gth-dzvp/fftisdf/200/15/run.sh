...
#SBATCH --job-name=diamond-kmp2-6-6-8-gth-dzvp-fftisdf-200-15
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-8 --basis=gth-dzvp --density-fitting-method=fftisdf-200-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
