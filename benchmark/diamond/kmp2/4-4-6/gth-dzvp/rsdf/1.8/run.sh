...
#SBATCH --job-name=diamond-kmp2-4-4-6-gth-dzvp-rsdf-1.8
#SBATCH --ntasks=1
...
python main.py --kmesh=4-4-6 --basis=gth-dzvp --density-fitting-method=rsdf-1.8 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
