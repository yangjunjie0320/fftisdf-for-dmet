...
#SBATCH --job-name=diamond-klno-1-1-2-gth-dzvp-fftisdf-100-15-1e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=1-1-2 --basis=gth-dzvp --lno-thresh=1e-5 --density-fitting-method=fftisdf-100-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
