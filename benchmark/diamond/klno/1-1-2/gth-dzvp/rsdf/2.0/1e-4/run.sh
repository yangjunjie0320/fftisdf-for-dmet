...
#SBATCH --job-name=diamond-klno-1-1-2-gth-dzvp-rsdf-2.0-1e-4
#SBATCH --ntasks=1
...
python main.py --kmesh=1-1-2 --basis=gth-dzvp --lno-thresh=1e-4 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
