...
#SBATCH --job-name=diamond-klno-4-6-6-gth-dzvp-fftisdf-200-10-3e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=4-6-6 --basis=gth-dzvp --lno-thresh=3e-6 --density-fitting-method=fftisdf-200-10 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
