...
#SBATCH --job-name=diamond-klno-4-6-6-gth-dzvp-fftisdf-50-5-1e-4
#SBATCH --ntasks=1
...
python main.py --kmesh=4-6-6 --basis=gth-dzvp --lno-thresh=1e-4 --density-fitting-method=fftisdf-50-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
