...
#SBATCH --job-name=diamond-klno-4-6-6-gth-dzvp-rsdf-2.0-1e-10
#SBATCH --ntasks=1
...
python main.py --kmesh=4-6-6 --basis=gth-dzvp --lno-thresh=1e-10 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
