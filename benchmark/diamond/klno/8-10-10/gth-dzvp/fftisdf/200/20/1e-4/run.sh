...
#SBATCH --job-name=diamond-klno-8-10-10-gth-dzvp-fftisdf-200-20-1e-4
#SBATCH --ntasks=1
...
python main.py --kmesh=8-10-10 --basis=gth-dzvp --lno-thresh=1e-4 --density-fitting-method=fftisdf-200-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
