...
#SBATCH --job-name=diamond-klno-2-2-2-gth-dzvp-fftisdf-150-20-3e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=2-2-2 --basis=gth-dzvp --lno-thresh=3e-6 --density-fitting-method=fftisdf-150-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
