...
#SBATCH --job-name=diamond-klno-2-3-3-gth-dzvp-fftisdf-200-15-1e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=2-3-3 --basis=gth-dzvp --lno-thresh=1e-5 --density-fitting-method=fftisdf-200-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
