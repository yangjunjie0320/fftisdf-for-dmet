...
#SBATCH --job-name=diamond-klno-2-3-3-gth-dzvp-fftisdf-200-20-1e-9
#SBATCH --ntasks=1
...
python main.py --kmesh=2-3-3 --basis=gth-dzvp --lno-thresh=1e-9 --density-fitting-method=fftisdf-200-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
