...
#SBATCH --job-name=diamond-klno-6-6-8-gth-dzvp-fftisdf-150-20-3e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-8 --basis=gth-dzvp --lno-thresh=3e-5 --density-fitting-method=fftisdf-150-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
