...
#SBATCH --job-name=diamond-klno-10-10-10-gth-dzvp-fftisdf-100-5-1e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=10-10-10 --basis=gth-dzvp --lno-thresh=1e-6 --density-fitting-method=fftisdf-100-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
