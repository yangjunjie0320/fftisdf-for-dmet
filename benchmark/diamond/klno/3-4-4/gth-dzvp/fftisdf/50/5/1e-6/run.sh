...
#SBATCH --job-name=diamond-klno-3-4-4-gth-dzvp-fftisdf-50-5-1e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --lno-thresh=1e-6 --density-fitting-method=fftisdf-50-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
