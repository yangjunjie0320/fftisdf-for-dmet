...
#SBATCH --job-name=diamond-klno-3-4-4-gth-dzvp-fftisdf-200-10-1e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --lno-thresh=1e-5 --density-fitting-method=fftisdf-200-10 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
