...
#SBATCH --job-name=diamond-klno-3-4-4-gth-dzvp-fftisdf-100-15-1e-4
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --lno-thresh=1e-4 --density-fitting-method=fftisdf-100-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
