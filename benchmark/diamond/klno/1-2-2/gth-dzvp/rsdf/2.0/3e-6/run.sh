...
#SBATCH --job-name=diamond-klno-1-2-2-gth-dzvp-rsdf-2.0-3e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=1-2-2 --basis=gth-dzvp --lno-thresh=3e-6 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
