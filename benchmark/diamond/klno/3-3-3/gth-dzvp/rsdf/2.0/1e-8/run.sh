...
#SBATCH --job-name=diamond-klno-3-3-3-gth-dzvp-rsdf-2.0-1e-8
#SBATCH --ntasks=1
...
python main.py --kmesh=3-3-3 --basis=gth-dzvp --lno-thresh=1e-8 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
