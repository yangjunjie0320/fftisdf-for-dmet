...
#SBATCH --job-name=diamond-klno-8-8-10-gth-dzvp-rsdf-2.0-1e-9
#SBATCH --ntasks=1
...
python main.py --kmesh=8-8-10 --basis=gth-dzvp --lno-thresh=1e-9 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
