...
#SBATCH --job-name=diamond-klno-6-6-6-gth-dzvp-fftisdf-200-15-1e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-6 --basis=gth-dzvp --lno-thresh=1e-6 --density-fitting-method=fftisdf-200-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
