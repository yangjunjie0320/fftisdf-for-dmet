...
#SBATCH --job-name=diamond-klno-6-6-6-gth-dzvp-fftisdf-150-5-1e-4
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-6 --basis=gth-dzvp --lno-thresh=1e-4 --density-fitting-method=fftisdf-150-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
