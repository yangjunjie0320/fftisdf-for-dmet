...
#SBATCH --job-name=diamond-klno-6-6-6-gth-dzvp-fftisdf-100-5-3e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=6-6-6 --basis=gth-dzvp --lno-thresh=3e-5 --density-fitting-method=fftisdf-100-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
