...
#SBATCH --job-name=diamond-klno-8-8-8-gth-dzvp-fftisdf-100-15-3e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=8-8-8 --basis=gth-dzvp --lno-thresh=3e-6 --density-fitting-method=fftisdf-100-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
