...
#SBATCH --job-name=diamond-klno-3-3-4-gth-dzvp-rsdf-2.0-1e-6
#SBATCH --ntasks=1
...
python main.py --kmesh=3-3-4 --basis=gth-dzvp --lno-thresh=1e-6 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
