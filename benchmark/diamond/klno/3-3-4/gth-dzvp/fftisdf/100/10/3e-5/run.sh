...
#SBATCH --job-name=diamond-klno-3-3-4-gth-dzvp-fftisdf-100-10-3e-5
#SBATCH --ntasks=1
...
python main.py --kmesh=3-3-4 --basis=gth-dzvp --lno-thresh=3e-5 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
