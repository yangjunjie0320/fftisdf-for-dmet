...
#SBATCH --job-name=diamond-gth-dzvp-8-8-10-fftdf-100-kpt
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=8-8-10 --density-fitting-method=fftdf-100 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
