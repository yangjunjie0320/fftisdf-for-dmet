...
#SBATCH --job-name=diamond-gth-dzvp-6-6-8-gdf-2.0-kpt
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=6-6-8 --density-fitting-method=gdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
