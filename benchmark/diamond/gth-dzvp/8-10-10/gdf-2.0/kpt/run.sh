...
#SBATCH --job-name=diamond-gth-dzvp-8-10-10-gdf-2.0-kpt
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=8-10-10 --density-fitting-method=gdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
