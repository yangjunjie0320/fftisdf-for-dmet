...
#SBATCH --job-name=diamond-gth-dzvp-1-2-2-fftisdf-100-10-klno-1e-10
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=1-2-2 --lno-thresh=1e-10 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
