...
#SBATCH --job-name=diamond-gth-dzvp-10-10-10-rsdf-2.0-klno-1e-7
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=10-10-10 --lno-thresh=1e-7 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
