...
#SBATCH --job-name=diamond-gth-dzvp-10-10-10-fftisdf-100-10-klno-1e-9
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=10-10-10 --lno-thresh=1e-9 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
