...
#SBATCH --job-name=diamond-gth-dzvp-10-10-10-fftdf-100-kpt
#SBATCH --ntasks=1
...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/src/scripts/main-kpt.py ./main.py
python main.py --basis=gth-dzvp --kmesh=10-10-10 --density-fitting-method=fftdf-100 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
