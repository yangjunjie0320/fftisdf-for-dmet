...
#SBATCH --job-name=diamond-gth-dzvp-8-8-8-rsdf-2.0-kmp2
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=8-8-8 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
