...
#SBATCH --job-name=diamond-gth-dzvp-8-8-8-fftisdf-100-10-klno-3e-7
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=8-8-8 --lno-thresh=3e-7 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
