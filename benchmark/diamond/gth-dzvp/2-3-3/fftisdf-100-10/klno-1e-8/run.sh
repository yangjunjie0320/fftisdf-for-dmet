...
#SBATCH --job-name=diamond-gth-dzvp-2-3-3-fftisdf-100-10-klno-1e-8
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=2-3-3 --lno-thresh=1e-8 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
