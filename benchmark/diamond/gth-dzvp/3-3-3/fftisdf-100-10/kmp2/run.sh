...
#SBATCH --job-name=diamond-gth-dzvp-3-3-3-fftisdf-100-10-kmp2
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=3-3-3 --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
