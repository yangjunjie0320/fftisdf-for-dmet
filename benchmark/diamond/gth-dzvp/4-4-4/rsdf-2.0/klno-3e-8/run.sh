...
#SBATCH --job-name=diamond-gth-dzvp-4-4-4-rsdf-2.0-klno-3e-8
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=4-4-4 --lno-thresh=3e-8 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
