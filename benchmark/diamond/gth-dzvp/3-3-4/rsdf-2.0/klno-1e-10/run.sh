...
#SBATCH --job-name=diamond-gth-dzvp-3-3-4-rsdf-2.0-klno-1e-10
#SBATCH --ntasks=1
...
python main.py --basis=gth-dzvp --kmesh=3-3-4 --lno-thresh=1e-10 --density-fitting-method=rsdf-2.0 --name=diamond --pseudo=gth-hf --init-guess-method=minao
echo "End time = $(date)"
