...
#SBATCH --job-name=diamond-krhf-3-4-4-gth-dzvp-fftisdf-200-15
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --density-fitting-method=fftisdf-200-15 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
