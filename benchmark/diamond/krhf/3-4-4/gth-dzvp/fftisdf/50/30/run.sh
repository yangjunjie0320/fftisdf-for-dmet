...
#SBATCH --job-name=diamond-krhf-3-4-4-gth-dzvp-fftisdf-50-30
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --density-fitting-method=fftisdf-50-30 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
