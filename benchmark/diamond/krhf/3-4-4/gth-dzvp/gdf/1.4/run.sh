...
#SBATCH --job-name=diamond-krhf-3-4-4-gth-dzvp-gdf-1.4
#SBATCH --ntasks=1
...
python main.py --kmesh=3-4-4 --basis=gth-dzvp --density-fitting-method=gdf-1.4 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
