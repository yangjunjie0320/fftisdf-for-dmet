...
#SBATCH --job-name=diamond-krhf-2-2-2-gth-dzvp-fftdf-150
#SBATCH --ntasks=1
...
python main.py --kmesh=2-2-2 --basis=gth-dzvp --density-fitting-method=fftdf-150 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
