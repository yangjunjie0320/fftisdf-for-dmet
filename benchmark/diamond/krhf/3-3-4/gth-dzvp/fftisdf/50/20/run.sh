...
#SBATCH --job-name=diamond-krhf-3-3-4-gth-dzvp-fftisdf-50-20
#SBATCH --ntasks=1
...
python main.py --kmesh=3-3-4 --basis=gth-dzvp --density-fitting-method=fftisdf-50-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
