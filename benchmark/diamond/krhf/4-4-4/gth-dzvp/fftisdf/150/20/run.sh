...
#SBATCH --job-name=diamond-krhf-4-4-4-gth-dzvp-fftisdf-150-20
#SBATCH --ntasks=1
...
python main.py --kmesh=4-4-4 --basis=gth-dzvp --density-fitting-method=fftisdf-150-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
