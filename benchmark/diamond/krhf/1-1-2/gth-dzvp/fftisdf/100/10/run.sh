...
#SBATCH --job-name=diamond-krhf-1-1-2-gth-dzvp-fftisdf-100-10
#SBATCH --ntasks=1
...
python main.py --kmesh=1-1-2 --basis=gth-dzvp --density-fitting-method=fftisdf-100-10 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
