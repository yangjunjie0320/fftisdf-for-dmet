...
#SBATCH --job-name=diamond-krhf-1-1-2-gth-dzvp-fftdf-200
#SBATCH --ntasks=1
...
python main.py --kmesh=1-1-2 --basis=gth-dzvp --density-fitting-method=fftdf-200 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
