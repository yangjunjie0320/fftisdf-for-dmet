...
#SBATCH --job-name=diamond-krhf-2-2-3-gth-dzvp-gdf-1.2
#SBATCH --ntasks=1
...
python main.py --kmesh=2-2-3 --basis=gth-dzvp --density-fitting-method=gdf-1.2 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
