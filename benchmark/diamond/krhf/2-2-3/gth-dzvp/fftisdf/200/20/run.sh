...
#SBATCH --job-name=diamond-krhf-2-2-3-gth-dzvp-fftisdf-200-20
#SBATCH --ntasks=1
...
python main.py --kmesh=2-2-3 --basis=gth-dzvp --density-fitting-method=fftisdf-200-20 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
