...
#SBATCH --job-name=diamond-krhf-2-2-3-gth-dzvp-fftdf-50
#SBATCH --ntasks=1
...
python main.py --kmesh=2-2-3 --basis=gth-dzvp --density-fitting-method=fftdf-50 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
