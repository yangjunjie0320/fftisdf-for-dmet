...
#SBATCH --job-name=diamond-krhf-1-2-2-gth-dzvp-fftisdf-200-5
#SBATCH --ntasks=1
...
python main.py --kmesh=1-2-2 --basis=gth-dzvp --density-fitting-method=fftisdf-200-5 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
