...
#SBATCH --job-name=diamond-krhf-2-3-3-gth-dzvp-fftisdf-150-30
#SBATCH --ntasks=1
...
python main.py --kmesh=2-3-3 --basis=gth-dzvp --density-fitting-method=fftisdf-150-30 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
