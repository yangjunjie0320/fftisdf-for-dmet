...
#SBATCH --job-name=diamond-krhf-3-3-3-gth-dzvp-fftisdf-200-25
#SBATCH --ntasks=1
...
python main.py --kmesh=3-3-3 --basis=gth-dzvp --density-fitting-method=fftisdf-200-25 --name=diamond --pseudo=gth-pbe --init-guess-method=minao
echo "End time = $(date)"
