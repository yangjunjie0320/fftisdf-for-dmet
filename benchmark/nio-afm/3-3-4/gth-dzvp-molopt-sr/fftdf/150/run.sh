...
python main.py --kmesh=3-3-4 --basis=gth-dzvp-molopt-sr --density-fitting-method=fftdf --ke-cutoff=150 --name=nio-afm --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None --is-unrestricted
echo "End time = $(date)"
