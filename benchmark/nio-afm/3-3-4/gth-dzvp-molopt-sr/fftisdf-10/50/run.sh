...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/../../src/scripts/main-kuhf.py /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/3-3-4/gth-dzvp-molopt-sr/fftisdf-10/50/main.py
python main.py --kmesh=3-3-4 --basis=gth-dzvp-molopt-sr --density-fitting-method=fftisdf-10 --ke-cutoff=50 --name=nio-afm --pseudo=gth-pbe --is-unrestricted=False --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
