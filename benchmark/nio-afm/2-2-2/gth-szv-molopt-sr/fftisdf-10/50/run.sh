...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/../../src/scripts/main-kuhf.py /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/2-2-2/gth-szv-molopt-sr/fftisdf-10/50/main.py
python main.py --kmesh=2-2-2 --basis=gth-szv-molopt-sr --density-fitting-method=fftisdf-10 --ke-cutoff=50 --name=nio-afm --pseudo=gth-pbe --is-unrestricted=False --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
