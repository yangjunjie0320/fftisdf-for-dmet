...
python main.py --kmesh=1-1-2 --basis=gth-dzvp-molopt-sr --density-fitting-method=fftdf --ke-cutoff=100 --name=nio-afm --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None --is-unrestricted
echo "End time = $(date)"
