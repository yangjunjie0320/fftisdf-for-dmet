...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/../../src/scripts/main-kuhf.py /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/2-2-3/gth-dzvp-molopt-sr/gdf/main.py
python main.py --kmesh=2-2-3 --basis=gth-dzvp-molopt-sr --density-fitting-method=gdf --ke-cutoff=0.0 --name=nio-afm --pseudo=gth-pbe --is-unrestricted=False --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
