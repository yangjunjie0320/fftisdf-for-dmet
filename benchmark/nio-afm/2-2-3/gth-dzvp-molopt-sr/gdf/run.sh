...
python main.py --kmesh=2-2-3 --basis=gth-dzvp-molopt-sr --density-fitting-method=gdf --ke-cutoff=0.0 --name=nio-afm --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None --is-unrestricted
echo "End time = $(date)"
