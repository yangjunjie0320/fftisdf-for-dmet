...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/../../src/scripts/main-kuhf.py /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/3-3-3/gth-szv-molopt-sr/fftisdf-40/50/main.py
python main.py --kmesh=3-3-3 --basis=gth-szv-molopt-sr --density-fitting-method=fftisdf-40 --ke-cutoff=50 --name=nio-afm --pseudo=gth-pbe --is-unrestricted=False --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
