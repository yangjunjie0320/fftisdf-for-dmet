...
python main.py --kmesh=2-3-3 --basis=gth-dzvp-molopt-sr --density-fitting-method=fftisdf-10 --ke-cutoff=400 --name=nio-afm --pseudo=gth-pbe --init-guess-method=minao --df-to-read=None --is-unrestricted
echo "End time = $(date)"
