...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/../../src/scripts/main-kuhf.py /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/nio-afm/3-4-4/gth-szv-molopt-sr/fftisdf-10/200/main.py
python main.py --kmesh=3-4-4 --basis=gth-szv-molopt-sr --density-fitting-method=fftisdf-10 --ke-cutoff=200 --name=nio-afm --pseudo=gth-pbe --is-unrestricted=False --init-guess-method=minao --df-to-read=None
echo "End time = $(date)"
