...
#SBATCH --job-name=diamond-gdf-2.0
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-3-3 --density-fitting-method=gdf-2.0 --name=diamond --init-guess-method=minao
echo "End time = $(date)"
