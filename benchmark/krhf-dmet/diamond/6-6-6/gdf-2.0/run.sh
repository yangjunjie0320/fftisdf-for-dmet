...
#SBATCH --job-name=diamond-gdf-2.0-kmesh-6-6-6
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=6-6-6 --density-fitting-method=gdf-2.0 --name=diamond --init-guess-method=chk
echo "End time = $(date)"
