...
#SBATCH --job-name=diamond-rsdf-2.0-kmesh-6-7-7
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=6-7-7 --density-fitting-method=rsdf-2.0 --name=diamond --init-guess-method=chk
echo "End time = $(date)"
