...
#SBATCH --job-name=diamond-fftdf-80-kmesh-6-7-7
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=6-7-7 --density-fitting-method=fftdf-80 --name=diamond --init-guess-method=chk
echo "End time = $(date)"
