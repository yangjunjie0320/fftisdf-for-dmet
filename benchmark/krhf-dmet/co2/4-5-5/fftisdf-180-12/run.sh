...
#SBATCH --job-name=co2-fftisdf-180-12-kmesh-4-5-5
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-5-5 --density-fitting-method=fftisdf-180-12 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
