...
#SBATCH --job-name=co2-fftisdf-160-16-kmesh-5-6-6
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=5-6-6 --density-fitting-method=fftisdf-160-16 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
