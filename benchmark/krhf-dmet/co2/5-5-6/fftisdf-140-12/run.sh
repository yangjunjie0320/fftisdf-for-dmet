...
#SBATCH --job-name=co2-fftisdf-140-12-kmesh-5-5-6
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=5-5-6 --density-fitting-method=fftisdf-140-12 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
