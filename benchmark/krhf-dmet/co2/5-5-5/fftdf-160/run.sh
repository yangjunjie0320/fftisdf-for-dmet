...
#SBATCH --job-name=co2-fftdf-160-kmesh-5-5-5
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=5-5-5 --density-fitting-method=fftdf-160 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
