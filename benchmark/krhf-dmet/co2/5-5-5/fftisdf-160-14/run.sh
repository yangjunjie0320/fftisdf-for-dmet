...
#SBATCH --job-name=co2-fftisdf-160-14-kmesh-5-5-5
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=5-5-5 --density-fitting-method=fftisdf-160-14 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
