...
#SBATCH --job-name=co2-fftisdf-180-10-kmesh-4-4-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftisdf-180-10 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
