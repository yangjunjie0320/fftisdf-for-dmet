...
#SBATCH --job-name=co2-fftdf-140-kmesh-4-4-4
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=4-4-4 --density-fitting-method=fftdf-140 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
