...
#SBATCH --job-name=co2-fftisdf-160-10-kmesh-2-2-2
#SBATCH --ntasks=1
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=2-2-2 --density-fitting-method=fftisdf-160-10 --name=co2 --init-guess-method=minao
echo "End time = $(date)"
