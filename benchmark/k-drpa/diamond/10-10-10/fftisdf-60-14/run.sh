...
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/src/code/scripts/main-k-drpa.py main.py
...
python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=10-10-10 --density-fitting-method=fftisdf-60-14 --name=diamond --init-guess-method=chk --kconserv-to-read=/resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/test/test-8-8-10/diamond-kconserv-wrap-around-1.chk
echo "End time = $(date)"
