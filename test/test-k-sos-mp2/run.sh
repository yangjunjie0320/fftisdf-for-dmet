...
#SBATCH --job-name=diamond-fftisdf-60-10
#SBATCH --ntasks=1
...
kmesh="3-3-4"
method="fftisdf-100-20"
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/diamond/${kmesh}/${method}/scf.chk scf.chk
cp /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/krhf-dmet/diamond/${kmesh}/${method}/tmp/df.h5 tmp/df.h5

grep "ene_corr_os" /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/benchmark/ref-kpts/diamond/${kmesh}/${method}/out.log > e-os-ref.txt

python main.py --basis=cc-pvdz --pseudo=gth-hf-rev --kmesh=${kmesh} --density-fitting-method=${method} --name=diamond --init-guess-method=chk --df-to-read=./tmp/df.h5 --kconserv-to-read=/resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/test/test-8-8-10/diamond-kconserv-wrap-around-1.chk
