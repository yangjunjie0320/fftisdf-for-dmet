...
python -m kernprof -lv -p /resnick/groups/changroup/members/junjiey/fftisdf-for-dmet/src/code/krpa.py\
          main.py --basis=cc-pvdz --density-fitting-method=fftisdf-60-8\
          --kmesh=5-5-6 --df-to-read=isdf.h5\
